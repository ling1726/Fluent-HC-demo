...
export var accessibleYellow = 'LinkText';
export var accessibleGreen = 'GrayText'; // always disabled color in high contrast

export var accessibleCyan = 'Highlight';
export var red = '#f00'; // COLOR SCHEME
